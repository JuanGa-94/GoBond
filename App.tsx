...
const App: React.FC = () => {
  ...
  const handleConfirmSelection = async () => {
    ...
    try {
      // Usar la validación de negocio antes de activar el seguimiento
      await supabase.validateAndSetSelection(user.id, pendingSchedule.route.id, pendingSchedule.id);
