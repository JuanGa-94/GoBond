      ...
      <aside className="hidden md:flex flex-col fixed inset-y-0 left-0 w-64 border-r border-border-subtle bg-surface p-6 z-40 transition-colors">
        ...
        <nav className="space-y-2">
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${activeTab === 'home' ? 'bg-primary text-background shadow-lg' : 'text-text/50 hover:bg-primary/10 hover:text-primary'}`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${activeTab === 'search' ? 'bg-primary text-background shadow-lg' : 'text-text/50 hover:bg-primary/10 hover:text-primary'}`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${activeTab === 'tips' ? 'bg-primary text-background shadow-lg' : 'text-text/50 hover:bg-primary/10 hover:text-primary'}`}
          >
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${activeTab === 'profile' ? 'bg-primary text-background shadow-lg' : 'text-text/50 hover:bg-primary/10 hover:text-primary'}`}
          >
          ...
          {user.role === UserRole.ADMIN && (
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${activeTab === 'admin' ? 'bg-primary text-background shadow-lg' : 'text-text/50 hover:bg-primary/10 hover:text-primary'}`}
            >
        ...
        <div className="mt-auto pt-6 border-t border-border-subtle space-y-4">
          ...
          <div className="flex items-center gap-3 px-2">
            ...
            <div className="overflow-hidden">
              ...
              <p className="text-text/40 text-[9px] uppercase font-bold">{user.role}</p>
            </div>
          </div>
